...
class stock_partial_picking(osv.osv):
    ...
    def prepare_epl_data(self, cr, uid, ids, context=None):
        ...
        partial_ids = partial_pick_obj.search(cr, uid, [('wizard_id', '=', ids), ('id', '=', line_ids_sorted)])
            ...
            if pool_ids:
                for i in pool_obj.browse(cr, uid, pool_ids, context=context):
                    ...
                    for fields in i.qz_field_ids:
                        ...
                        printing_field = self.pool.get(model).read(cr, uid, partial_ids, [name_field], context=context)
    ...
    def do_partial_print(self, cr, uid, ids, context=None):
        ...
        # sort by sku
        partial_sorted = sorted(partial, key=partial.default_code)
        for wizard_line in partial_sorted.move_ids:
