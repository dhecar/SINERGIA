    ...
    def get_prices(self, cr, uid, ids, context=None):
        ...
        for product in self.browse(cr, uid, ids, context=context):
            for asoc in product.asoc_id:
                ...
                htmltext = htmlmin.minify(htmlencoded, remove_comments=True, remove_empty_space=True,
                                          remove_all_empty_space=False, reduce_empty_attributes=True,
                                          reduce_boolean_attributes=True, remove_optional_attribute_quotes=False,
                                          keep_pre=False, pre_tags=(u'pre', u'textarea'), pre_attr='pre')
