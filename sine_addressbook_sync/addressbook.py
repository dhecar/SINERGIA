##############################################################################
#
# Sinergia Informatica
# David Hernandez. 2015
#
...
try:
    import ldap
    CONNECTORS.append(('ldap', 'LDAP'))
except:
    _logger.info('LDAP libraries not available. Please install "ldap"'
                 ' python package.')
...
class AddressBookConf(orm.Model):
    _name = 'addressbook.conf'
    _descripcion = 'Configuration for Asterisk DB connection'
    _table = 'addressbook_config'
    _columns = {
